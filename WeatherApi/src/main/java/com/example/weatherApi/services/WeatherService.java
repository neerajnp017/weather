...
import com.example.weatherApi.Weather;
...
public class WeatherService extends MappingJackson2HttpMessageConverter   {
    ...
    public List<Example> getWeatherForFive(String city) throws ParseException {
    	String apiKey = "bc6c6c08718b147e3a4a8bac27a5f8ac";
    	String websiteResponse = "http://api.openweathermap.org/data/2.5/forecast?q=" + city + "&mode=json&appid="+apiKey+"&units=metric";
